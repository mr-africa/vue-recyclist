...
var update = __webpack_require__(1)("b0d6fd62", content, true);
...
// module
exports.push([module.i, "body,html{height:100%}body{margin:0;padding:0}#app{font-family:Avenir,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;color:#2c3e50;overflow:hidden;padding:120px 20px 50px;height:100%;background:#fff}#app,#app header{text-align:center;width:100%;box-sizing:border-box}#app header{position:absolute;top:0;left:0;height:120px;display:flex;flex-direction:column;justify-content:center;align-items:center}#app header h1,#app header h2{font-weight:400;margin:0}#app header h1{font-size:24px}#app header h2{font-size:14px}#app header h2 a{color:inherit}#app header a{font-size:12px;text-decoration:underline;margin-top:10px;cursor:pointer}#app .info{font-size:12px;color:#999}#app .info a{font-style:italic;color:inherit}#app .cssloading-circle{background:#eee}#app .vue-recyclist-item{contain:layout}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("71985390", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("7949f8ef", content, true);
